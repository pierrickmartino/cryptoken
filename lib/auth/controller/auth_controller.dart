...
import 'package:web_dashboard/auth/model/user_model.dart';
...
class AuthController extends GetxController {
  ...
  Future<void> handleAuthChanged(dynamic _firebaseUser) async {
    ...
    if (_firebaseUser == null) {
      ...
      await Get.offAll<SignInUI>(SignInUI());
    } else {
      await Get.offAll<HomeUI>(const HomeUI());
    }
  }
